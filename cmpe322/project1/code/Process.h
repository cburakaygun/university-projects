...
struct Process{
    ...
    /*
     * Note that instructions (actually, durations of instructions) are stored in an array indices of which start from 0 and
     * lastInstNumber, which is the number of the last instruction that was executed, starts from 1.
     */
    vector<int> instructions;   // An array that stores the duration (e.g. 40) of each atomic instruction of the process.
